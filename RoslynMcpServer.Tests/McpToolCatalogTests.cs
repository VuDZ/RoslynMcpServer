...
{
    public const int FullCatalogBudgetBytes = 70 * 1024;

    /// <summary>
    /// Epoch 1 ceiling before description compaction. Measured lite list is ~23 KB because
    /// the 15 core tools still carry the verbose <c>[Description]</c> text. Epoch 2 target remains 20 KB.
    /// </summary>
    public const int LiteCatalogBudgetBytes = 24 * 1024;
    ...
    public void Explicit_full_contains_every_pre_existing_tool()
    {
        ...
        Assert.Equal(59, reflected.Length);
    ...
    public void Lite_does_not_register_excluded_tools_in_sdk_collection()
    {
        ...
        Assert.DoesNotContain("list_tool_groups", registered);
    }
    ...
    [Fact]
    public void Minified_tools_list_sizes_are_within_epoch1_budgets()
    {
