...
public static class McpToolCatalog
{
    ...
    private static IReadOnlyList<McpToolDescriptor> Build()
    {
        ...
        [
            ...
            Group<CodeSkeletonTools>("get_code_skeleton", McpToolGroups.Files, readOnly: true),
            ...
            Group<NavigationTools>("find_symbol_references", McpToolGroups.Navigation, readOnly: true),
            Group<NavigationTools>("find_implementations", McpToolGroups.Navigation, readOnly: true),
            Group<NavigationTools>("get_call_graph", McpToolGroups.Navigation, readOnly: true),
