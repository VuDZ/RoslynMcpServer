...
В данном проходе создания v2 внешние документы и комментарии к коду не изменяются;
DOC-EARLY не отмечается выполненной. В самой v2 фактическое описание уже исправлено.
