...
Ревизия спецификации от 2026-09-11. Реализация, экспериментальные результаты и
релиз продукта этим изменением не заявляются. Исходные v1/review/response/arbitration
...
- U-ARB-01–05 полностью сохранены в [UNRESOLVED-v2.md](UNRESOLVED-v2.md).
  U-ARB-02/03/04/05 остаются открытыми условиями принятых решений, даже когда
  соответствующий review finding имеет ACCEPT WITH MODIFICATION.
