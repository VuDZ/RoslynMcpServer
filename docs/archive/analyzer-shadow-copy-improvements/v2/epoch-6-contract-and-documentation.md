...
Статус: **аудит документации завершён** ([результаты](epoch-6-results.md),
[приёмка](epoch-6-acceptance.md)). S1–S4 приняты. Зависимости: фактические
результаты или явно отложенные части эпох 1–5. Runtime-работа не переносится
сюда. Серия **не завершена** (U-ARB-04 и inaccessible в U-ARB-01; эпоха 5
принята в v1.3.12, U-ARB-05 выбран в v1.3.13).
...
принято U-ARB-05 как session-sticky в v1.3.13: cached false/omitted сохраняет
overlay, отключение требует reset/new session. Новые MCP параметры не вводились.
