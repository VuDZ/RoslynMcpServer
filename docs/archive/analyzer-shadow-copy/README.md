...
- Timestamp layout and recopy-on-edit below are **v1.3.5 history**. Forward spec and audit: [`docs/archive/analyzer-shadow-copy-improvements/v2/`](../analyzer-shadow-copy-improvements/v2/README.md). Current runtime — [ARCHITECTURE](../../ARCHITECTURE.md).
