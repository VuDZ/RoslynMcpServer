# MCP tool surface evolution — proposal v1 (superseded)

Не норма. Живой канон — [../../README.md](../../README.md). Этот каталог —
доарбитражный план 2026-09-19.

Дата: 2026-09-19. Статус: **архив; заменён post-arbitration v2**.
...
| [2 — symbol identity 1.x](stage-2-symbol-identity.md) | `symbolId` + `get_symbol_info` / `get_symbol_source`; optional params на старых именах | minor 1.4 | 1 желателен |
