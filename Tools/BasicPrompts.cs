...
4. For C# insertions use `add_using`, `add_method_to_class`, `add_property_to_class` — not manual patch. For bug context use `get_call_graph`. Verify server binary with `get_mcp_server_info` after publish.";
        }
